...
public class tema789 {
    ...
    public static class ArrayUnidimensional {
        ...
        public static void main(String[] args) {
            ...
            String textos[] = {"hola ", "encantado ", "adios "};
    ...
    public static class EjercicioVector {
        ...
        public static void main(String[] args) {
            ...
            */
            ...
            System.out.println("supera limite establecido y se duplica la dimension del vector, por lo que tambien se desperdicia mucha memoria");
        }
    }
